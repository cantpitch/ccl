...
/* Other than formatting, this is a direct copy from ppc_print.c and may not
...
void add_lisp_base_string(LispObj str)
{
...
void sprint_signed_decimal(signed_natural n)
{
    sprintf(numbuf, "%ld", n);
    add_c_string(numbuf);
}

void sprint_unsigned_decimal(natural n)
{
    sprintf(numbuf, "%lu", n);
    add_c_string(numbuf);
}

void sprint_unsigned_hex(natural n)
{
    sprintf(numbuf, "#x%016lx", n);
    add_c_string(numbuf);
}

void sprint_list(LispObj o, int depth)
{
    LispObj the_cdr;
...
void sprint_specializers_list(LispObj o, int depth)
{
...
void sprint_random_vector(LispObj o, unsigned subtag, natural elements)
{
    add_c_string("#<");
...
void sprint_function(LispObj o, int depth)
{
...
void sprint_gvector(LispObj o, int depth)
{
...
void sprint_vector(LispObj o, int depth)
{
    LispObj header = header_of(o);
...
void sprint_lisp_object(LispObj o, int depth)
{
    if (--depth < 0)
    {
        add_char('#');
