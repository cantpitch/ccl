...
LispObj purify_displaced_object(LispObj obj, area *dest, natural disp)
{
    BytePtr
        free = dest->active,
        ...
        case fulltag_misc:
            ...
            else
            {
                ...
                do
                {
                    ...
                    tag += 8;
                    insn = *p;
                } while (insn != ARM64_CODE_VECTOR_PREFIX);
                headerP = ((LispObj *)p) - 1;
...
void purify_range(LispObj *start, LispObj *end, BytePtr low, BytePtr high, area *to)
{
    LispObj header;
    unsigned tag;
...
void purify_tstack_area(area *a, BytePtr low, BytePtr high, area *to)
{
    LispObj
        *current,
        *next,
...
void purify_vstack_area(area *a, BytePtr low, BytePtr high, area *to)
{
    LispObj
        *p = (LispObj *)a->active,
        *q = (LispObj *)a->high;
...
void purify_cstack_area(area *a, BytePtr low, BytePtr high, area *to)
{
    BytePtr
        current,
        next,
...
void purify_tcr_tlb(TCR *tcr, BytePtr low, BytePtr high, area *to)
{
...
void purify_tcr_xframes(TCR *tcr, BytePtr low, BytePtr high, area *to)
{
    xframe_list *xframes;
    ExceptionInformation *xp;
...
void purify_gcable_ptrs(BytePtr low, BytePtr high, area *to)
{
...
void purify_areas(BytePtr low, BytePtr high, area *target)
{
    area *next_area;
    area_code code;
...
#ifdef PPC
void impurify_cstack_area(area *a, LispObj low, LispObj high, int delta)
{
    BytePtr
        current,
        next,
...
void impurify_range(LispObj *start, LispObj *end, LispObj low, LispObj high, int delta)
{
    LispObj header;
    unsigned tag;
...
void impurify_tcr_tlb(TCR *tcr, LispObj low, LispObj high, int delta)
{
...
void impurify_tcr_xframes(TCR *tcr, LispObj low, LispObj high, int delta)
{
    xframe_list *xframes;
    ExceptionInformation *xp;
...
void impurify_tstack_area(area *a, LispObj low, LispObj high, int delta)
{
    LispObj
        *current,
        *next,
...
void impurify_vstack_area(area *a, LispObj low, LispObj high, int delta)
{
    LispObj
        *p = (LispObj *)a->active,
        *q = (LispObj *)a->high;
...
void impurify_areas(LispObj low, LispObj high, int delta)
{
    area *next_area;
    area_code code;
...
void impurify_gcable_ptrs(LispObj low, LispObj high, signed_natural delta)
{
    LispObj *prev = &(lisp_global(GCABLE_POINTERS)), next;
...
signed_natural impurify(TCR *tcr, signed_natural param)
{
